?php
/**
 * Plugin Name: Product to Spreadsheet - WooCommerce
...
add_shortcode( 'download_prices', 'prices_spreadsheet' );

function prices_spreadsheet( $atts, $content = null ) {
...
function get_products_xls() {
    ...
    // Set the cache expiration time to 60 minutes
    $cache_expiration = 60 * MINUTE_IN_SECONDS;

    // Get the path and URL of the uploads folder
    $upload_dir = wp_upload_dir();
    $file_path = $upload_dir['basedir'] . '/products.xls';

    // Check if the file exists and has been modified in the past 60 minutes
